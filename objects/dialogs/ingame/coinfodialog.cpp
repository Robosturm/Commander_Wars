      ...
      m_Ingame(ingame)
{
    ...
    m_NextButton->setPosition(oxygine::Stage::getStage()->getWidth() - m_NextButton->getScaledWidth() - 30,
                              oxygine::Stage::getStage()->getHeight() - 30 - m_NextButton->getScaledHeight());
    ...
    m_QuitButton->setPosition(oxygine::Stage::getStage()->getWidth() / 2 - m_QuitButton->getScaledWidth() / 2,
                              oxygine::Stage::getStage()->getHeight() - 30 - m_QuitButton->getScaledHeight());
    ...
    m_BackButton->setPosition(30, oxygine::Stage::getStage()->getHeight() - 30 - m_BackButton->getScaledHeight());
    ...
    m_COInfo = MemoryManagement::create<COInfoActor>(pMap, m_pPanel->getScaledWidth());
