...
ProgressInfoBar::ProgressInfoBar(qint32 width, qint32 heigth, QString text, float progress)
{
    ...
    m_Background = MemoryManagement::create<oxygine::ColorRectSprite>();
    m_Background->setSize(width, heigth);
    m_Background->setColor(QColor(100, 100, 100, 150));
    addChild(m_Background);

    m_Progressbar = MemoryManagement::create<oxygine::ColorRectSprite>();
    ...
    m_Label = MemoryManagement::create<Label>(width);
