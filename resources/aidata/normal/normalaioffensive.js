...
{    
    ...
    {
        return AI_BEHAVIOR_DISPATCH.getBuildingMenuItem(NORMALAIOFFENSIVE.buildingMenuFunctions, ai, action, ids, costs, enabled, units, buildings, owner, map);
    },
    ...
    {
        return AI_BEHAVIOR_DISPATCH.initializeSimpleProductionSystem(system, ai, map, NORMALAIOFFENSIVE.groupDistribution);
    },
    ...
    {
        return AI_BEHAVIOR_DISPATCH.onNewBuildQueue(system, ai, buildings, units, enemyUnits, enemyBuildings, map, NORMALAIOFFENSIVE.groupDistribution);
    },
};
