var Constructor = function()
{
    ...
    {
        return qsTr("A player looses when he looses his last HQ. All buildings will be owned by the current player. A captured HQ and neutral HQ's will be converted into a town.")
    };
