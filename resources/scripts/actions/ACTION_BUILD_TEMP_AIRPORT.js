var Constructor = function()
{
    ...
    {
        return qsTr("Orders an APC to build an airport on a plain which can be used to repair and resupply air units. Successfully building the airport will reduce the material of the APC by 1.");
    };
}
