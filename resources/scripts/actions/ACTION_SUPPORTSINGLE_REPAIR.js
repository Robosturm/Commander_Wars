var Constructor = function()
{
    this.canBePerformed = function(action, map)
    {
        ...
        if (((actionTargetField.x === targetField.x) && (actionTargetField.y === targetField.y) ||
            ...
            (ACTION_SUPPORTSINGLE_REPAIR.getRepairFields(action, map).length > 0))
        {
            return true;
        }
        else
    ...
    this.getStepData = function(action, data, map)
    {
        ...
        var fields = ACTION_SUPPORTSINGLE_REPAIR.getRepairFields(action, map);
    ...
    this.performPostAnimation = function(postAnimation, map)
    {
        ...
        var repairUnit = terrain.getUnit();
        var animation = GameAnimationFactory.createAnimation(map, ACTION_SUPPORTSINGLE_REPAIR.postAnimationTargetX, ACTION_SUPPORTSINGLE_REPAIR.postAnimationTargetY);
