...
var TERRAIN =
{
    ...
    paletteTable : [[qsTr("Default"),       "",                     "",                     "",                     "",                     "",],
                    ...
                    [qsTr("Wargroove Desert"),     "palette_clear+wg",     "palette_clear+wg",     "palette_desert+sfw",    "palette_snow+wg",      "palette_waste+wg"],
                    [qsTr("Wargroove Snow"),     "palette_clear+wg",     "palette_clear+wg",     "palette_desert+wg",    "palette_snow+sfw",      "palette_waste+wg"],
                    [qsTr("Wargroove Waste"),     "palette_clear+wg",     "palette_clear+wg",     "palette_desert+wg",    "palette_snow+wg",      "palette_waste+sfw"],],
