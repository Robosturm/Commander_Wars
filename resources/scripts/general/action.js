...
var ACTION =
{
    ...
    getEmptyFieldActions : function()
    {
        return "ACTION_ACTIVATE_POWER_CO_0,ACTION_ACTIVATE_POWER_CO_1,ACTION_ACTIVATE_SUPERPOWER_CO_0," +
               "ACTION_ACTIVATE_SUPERPOWER_CO_1,ACTION_ACTIVATE_TAGPOWER,ACTION_COINFO," +
               "ACTION_DELETE_UNIT,ACTION_VICTORYINFO,ACTION_SURRENDER,ACTION_EXITGAME,ACTION_SAVEGAME,"+
