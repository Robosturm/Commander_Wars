...
var ACTION =
{
    ...
    getEmptyFieldActions : function()
    {
        return "ACTION_ACTIVATE_POWER_CO_0,ACTION_ACTIVATE_POWER_CO_1,ACTION_ACTIVATE_SUPERPOWER_CO_0," +
               ...
               "ACTION_VICTORYINFO,ACTION_UNITINFO,ACTION_NICKNAME_UNIT,ACTION_DELETE_UNIT,ACTION_ATTACKLOG,ACTION_SURRENDER," +
               "ACTION_EXITGAME,ACTION_SAVEGAME,ACTION_NEXT_PLAYER,ACTION_SWAP_COS";
    },
