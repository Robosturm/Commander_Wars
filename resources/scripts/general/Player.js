var PLAYER =
{
    ...
    colorShades : [[Qt.point(2, 0),     40],
                   ...
                   [Qt.point(136, 133),   60],
                   [Qt.point(139, 133),   90],
                   [Qt.point(142, 133),   130],
                   [Qt.point(145, 133),   160],
                   [Qt.point(148, 133),   "#ffffff"],
                   // 3 row
                   ...
                   // grays 1
                   [Qt.point(2, 133),   "#586070"],
                   [Qt.point(5, 133),   "#889098"],
                   [Qt.point(8, 133),   "#b0b8c8"],
                   // grays 2
                   ...
                   [Qt.point(17, 139),  "#646c6e"],
                   [Qt.point(20, 139),  "#98a6a6"],
                   // grays 4
                   [Qt.point(2,  142),  "#393039"],
                   [Qt.point(5,  142),  "#4a494a"],
                   [Qt.point(8,  142),  "#847973"],
                   [Qt.point(11, 142),  "#d6cbbd"],
                   // grays 5
                   [Qt.point(2,  145),  "#393039"],
                   [Qt.point(5,  145),  "#4a494a"],
                   [Qt.point(8,  145),  "#847973"],
                   [Qt.point(11, 145),  "#d6cbbd"],
                   // grays 7
                   [Qt.point(2,  148),  "#584060"],
                   [Qt.point(5,  148),  "#807878"],
                   [Qt.point(8,  148),  "#b8a890"],
                   [Qt.point(17, 148),  "#2f0f29"],
                   [Qt.point(20, 148),  "#494949"],
                   [Qt.point(23, 148),  "#666666"],
                   [Qt.point(26, 148),  "#7f7f7f"],
                   [Qt.point(29, 148),  "#9a9a9a"],
                   // grays 8
                   [Qt.point(2,  151),  "#404040"],
                   [Qt.point(5,  151),  "#686868"],
                   [Qt.point(8,  151),  "#a0a0a0"],
                   // face 1
                   [Qt.point(130,  5),  "#de8252"],
                   [Qt.point(133,  5),  "#ffdb84"],
                   [Qt.point(139,  5),  "#a8d8e0"],
                   // face 2
                   [Qt.point(130,  8),  "#905038"],
                   [Qt.point(133,  8),  "#f89860"],
                   [Qt.point(136,  8),  "#f8d090"],
                   [Qt.point(139,  8),  "#006888"],
                   [Qt.point(142,  8),  "#88e8a8"],
                   // face 3
                   [Qt.point(139, 11),  "#f0b838"],
                   [Qt.point(142, 11),  "#f8f0a0"],
                   // face 4
                   [Qt.point(139, 14),  "#f0b838"],
                   [Qt.point(142, 14),  "#f8f0a0"],
                   // face 6
                   [Qt.point(139, 17),  "#f0b838"],
                   [Qt.point(142, 17),  "#f8f0a0"],
                   // face 7
                   [Qt.point(130, 20),  "#885850"],
                   [Qt.point(133, 20),  "#a86848"],
                   [Qt.point(136, 20),  "#f0b058"],
    ],
