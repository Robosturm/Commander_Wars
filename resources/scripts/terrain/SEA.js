var Constructor = function()
{
    ...
    this.getOverlayTerrainSprites = function(map)
    {
        return ["sea+snow+E+mask",
                ...
                "riverend+S+1+mask",
                "riverend+W+1+mask",
                "riverend+N+1+land+W+mask",
                "riverend+E+1+land+N+mask",
                "riverend+S+1+land+W+mask",
                "riverend+W+1+land+N+mask",
                "riverend+N+1+land+N+mask",
                "riverend+W+1+land+W+mask",
                "riverend+N+1+land+N+W+mask",
                "riverend+W+1+land+N+W+mask",
                "riverend+N+1+land+NW+mask",
                "riverend+W+1+land+NW+mask",
                "riverend+N+2+mask",
                "riverend+E+2+mask",
                "riverend+S+2+mask",
                "riverend+W+2+mask",
                "riverend+S+2+land+E+mask",
                "riverend+E+2+land+E+mask",
                "riverend+E+2+land+N+mask",
                "riverend+N+2+land+E+mask",
                "riverend+N+2+land+N+mask",
                "riverend+W+2+land+N+mask",
                "riverend+E+2+land+N+E+mask",
                "riverend+N+2+land+N+E+mask",
                "riverend+N+2+land+NE+mask",
                "riverend+E+2+land+NE+mask",
                "riverend+N+3+mask",
                "riverend+E+3+mask",
                "riverend+S+3+mask",
                "riverend+W+3+mask",
                "riverend+E+3+land+E+mask",
                "riverend+N+3+land+E+mask",
                "riverend+S+3+land+E+mask",
                "riverend+S+3+land+S+mask",
                "riverend+W+3+land+S+mask",
                "riverend+E+3+land+S+mask",
                "riverend+S+3+land+E+S+mask",
                "riverend+E+3+land+E+S+mask",
                "riverend+S+3+land+SE+mask",
                "riverend+E+3+land+SE+mask",
                "riverend+N+4+mask",
                "riverend+E+4+mask",
                "riverend+S+4+mask",
                "riverend+W+4+mask",
                "riverend+S+4+land+W+mask",
                "riverend+E+4+land+S+mask",
                "riverend+N+4+land+W+mask",
                "riverend+S+4+land+S+mask",
                "riverend+W+4+land+S+mask",
                "riverend+W+4+land+W+mask",
                "riverend+S+4+land+S+W+mask",
                "riverend+W+4+land+S+W+mask",
                "riverend+W+4+land+SW+mask",
                "riverend+S+4+land+SW+mask",];
    };
