var Constructor = function()
{
    ...
    {
        building.loadSpriteV2("grand_bolt+eye+left+mask", GameEnums.Recoloring_Matrix);
    };
    ...
    {
        return BUILDING.canLargeBuildingPlaced(terrain, building, ZGRAND_BOLT_EYE_LEFT.getBuildingWidth(), ZGRAND_BOLT_EYE_LEFT.getBuildingHeigth(), map);
    };
    ...
    this.onDestroyed = function(building, map)
    {
        ...
        terrain.loadBuilding("ZGRAND_BOLT_EYE_LEFT_DESTROYED");
        terrain.getBuilding().setOwner(owner);
    };
}

Constructor.prototype = BUILDING;
var ZGRAND_BOLT_EYE_LEFT = new Constructor();
