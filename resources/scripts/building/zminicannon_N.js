var Constructor = function()
{
    ...
    {
        building.loadSpriteV2("minicannon+N", GameEnums.Recoloring_Matrix, 400, Qt.point(0,0), TERRAIN.getBuildingTerrainPalette(building));
    ...
    this.getShotAnimation = function(building, map)
    {
        ...
        animation.addSprite("minicanon_north", -map.getImageSize() * 0.5, -map.getImageSize() * 1.5, 0, 2);
