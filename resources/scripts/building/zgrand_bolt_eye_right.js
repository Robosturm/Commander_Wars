var Constructor = function()
{
    ...
    {
        building.loadSpriteV2("grand_bolt+eye+right+mask", GameEnums.Recoloring_Matrix);
    };
    ...
    {
        return BUILDING.canLargeBuildingPlaced(terrain, building, ZGRAND_BOLT_EYE_RIGHT.getBuildingWidth(), ZGRAND_BOLT_EYE_RIGHT.getBuildingHeigth(), map);
    };
    ...
    this.onDestroyed = function(building, map)
    {
        ...
        terrain.loadBuilding("ZGRAND_BOLT_EYE_RIGHT_DESTROYED");
        terrain.getBuilding().setOwner(owner);
    };
}

Constructor.prototype = BUILDING;
var ZGRAND_BOLT_EYE_RIGHT = new Constructor();
