var Constructor = function()
{
    ...
    this.loadMoveInAnimation = function(sprite, unit, defender, weapon)
    {
        ...
        BATTLEANIMATION_DESTROYER.loadSprite(sprite, unit, defender, weapon, Qt.point(-58, 0), 580, Qt.point(20, 20));
    };
    ...
    {
        BATTLEANIMATION_DESTROYER.loadSprite(sprite, unit, defender, weapon, Qt.point(0, 0), 0, Qt.point(-38, 20));
    };
    ...
    this.loadFireAnimation = function(sprite, unit, defender, weapon)
    {
        ...
        BATTLEANIMATION_DESTROYER.loadStandingAnimation(sprite, unit, defender, weapon, Qt.point(-38, 20));
    ...
    {
        BATTLEANIMATION_DESTROYER.loadSprite(sprite, unit, defender, weapon, Qt.point(-140, 0), 2000, Qt.point(-38, 20));
