var Constructor = function()
{
    ...
    this.activateSuperpower = function(co, powerMode, map)
    {
        ...
        CO_MINA.minaDamage(co, CO_MINA.superPowerDamage, dialogBuilder, map);

        dialogBuilder.displayAnimation();
    };

    this.minaDamage = function(co, value, parentBuilder, map)
    {
    ...
    this.loadCOMusic = function(co, map)
    {
        if (CO.isActive(co))
        {
            ...
            case GameEnums.PowerMode_Tagpower:
                ...
                break;
            default:
                audio.addMusic("resources/music/cos/mina.ogg", 76, 100073);
                break;
            }
        }
    };
