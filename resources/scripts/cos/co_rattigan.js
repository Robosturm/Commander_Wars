var Constructor = function()
{
    ...
    this.activatePower = function(co, map)
    {
        ...
        ownUnitsBuilder.setSounds(["power10_1.wav", "power10_2.wav"]);
        ownUnitsBuilder.setSprite("power10");
    ...
    this.activateSuperpower = function(co, powerMode, map)
    {
        ...
        CO_RATTIGAN.rattiganDamage(co, CO_RATTIGAN.superPowerDamage, dialogBuilder, map);

        dialogBuilder.displayAnimation();
    };

    this.rattiganDamage = function(co, value, parentBuilder, map)
    {
