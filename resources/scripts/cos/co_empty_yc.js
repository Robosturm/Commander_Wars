    ...
    this.loadCOMusic = function(co, map)
    {
        if (CO.isActive(co))
        {
            ...
            case GameEnums.PowerMode_Tagpower:
                ...
                break;
            default:
                audio.addMusic("resources/music/cos/yellow_comet+0.ogg", 0, 30806)
                audio.addMusic("resources/music/cos/yellow_comet+1.ogg", 0, 30369);
                break;
            }
        }
    };
...
var CO_EMPTY_YC = new Constructor();
