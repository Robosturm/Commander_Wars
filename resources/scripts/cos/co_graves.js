var Constructor = function()
{
    ...
    this.loadCOMusic = function(co, map)
    {
        if (CO.isActive(co))
        {
            ...
            case GameEnums.PowerMode_Tagpower:
                ...
                break;
            default:
                audio.addMusic("resources/music/cos/graves.ogg")
                break;
            }
        }
    };
    ...
    this.activatePower = function(co, map)
    {
        ...
        CO_GRAVES.gravesDamage(co, CO_GRAVES.powerDamage, CO_GRAVES.powerStunLevel, dialogBuilder, map);
    ...
    this.activateSuperpower = function(co, powerMode, map)
    {
        ...
        CO_GRAVES.gravesDamage(co, CO_GRAVES.superPowerDamage, CO_GRAVES.superPowerStunLevel, dialogBuilder, map);

        dialogBuilder.displayAnimation();
    };

    this.gravesDamage = function(co, value, stunLevel, parentBuilder, map)
    {
