var Constructor = function() { // scriptStart
    ...
    // preconditionend
        if (team === 0) { // 0 Victory
            ...
            var dialog3 = GameAnimationFactory.createGameAnimationDialog(qsTr("You're right."), "CO_LIN", GameEnums.COMood_Normal, "#ff0000"); dialog3.loadBackground("maps/advance_wars_day_of_ruin_campaign/cutscenes/bg_normal_general.png"); // 1 ScriptEventDialogItem
            var dialog4 = GameAnimationFactory.createGameAnimationDialog(qsTr("EEEEEK!"), "CO_GREYFIELD", GameEnums.COMood_Normal, "#d08000"); dialog4.loadBackground("maps/advance_wars_day_of_ruin_campaign/cutscenes/bg_normal_general.png"); // 1 ScriptEventDialogItem
            var dialog5 = GameAnimationFactory.createGameAnimationDialog(qsTr("Defeat is for the weak. You were defeated because you were weak. And now you're going to die."), "CO_LIN", GameEnums.COMood_Normal, "#ff0000"); dialog5.loadBackground("maps/advance_wars_day_of_ruin_campaign/cutscenes/bg_normal_general.png"); // 1 ScriptEventDialogItem
            var dialog6 = GameAnimationFactory.createGameAnimationDialog(qsTr("Y-you wouldn't dare!"), "CO_GREYFIELD", GameEnums.COMood_Normal, "#d08000"); dialog6.loadBackground("maps/advance_wars_day_of_ruin_campaign/cutscenes/bg_normal_general.png"); // 1 ScriptEventDialogItem
            var dialog7 = GameAnimationFactory.createGameAnimationDialog(qsTr("Actually, I would. Will wouldn't. Will would try to put you on trial or something."), "CO_LIN", GameEnums.COMood_Normal, "#ff0000"); dialog7.loadBackground("maps/advance_wars_day_of_ruin_campaign/cutscenes/bg_normal_general.png"); // 1 ScriptEventDialogItem
            var dialog8 = GameAnimationFactory.createGameAnimationDialog(qsTr("But Will isn't here. Is he?"), "CO_LIN", GameEnums.COMood_Normal, "#ff0000"); dialog8.loadBackground("maps/advance_wars_day_of_ruin_campaign/cutscenes/bg_lin.png"); // 1 ScriptEventDialogItem
            var dialog9 = GameAnimationFactory.createGameAnimationDialog(qsTr("You wouldn't dare...! Y-you can't...! You can't do this!"), "CO_GREYFIELD", GameEnums.COMood_Normal, "#d08000"); dialog9.loadBackground("maps/advance_wars_day_of_ruin_campaign/cutscenes/bg_lin.png"); // 1 ScriptEventDialogItem
            var dialog10 = GameAnimationFactory.createGameAnimationDialog(qsTr("You are responsible for the death of Captain Brenner. You killed him, and now I'm going to kill you. Will and the others won't like it... But it's what needs to be done."), "CO_LIN", GameEnums.COMood_Normal, "#ff0000"); dialog10.loadBackground("maps/advance_wars_day_of_ruin_campaign/cutscenes/bg_lin.png"); // 1 ScriptEventDialogItem
            var dialog11 = GameAnimationFactory.createGameAnimationDialog(qsTr("Stop! I... I... I surrender! I surrender my forces to you! Th-there! You can't hurt me now! I am a prisoner of war! C-C-Captain Brenner would never hurt a prisoner! It's murder! If you kill me, you're as bad as me! You'll be just the same as me!"), "CO_GREYFIELD", GameEnums.COMood_Normal, "#d08000"); dialog11.loadBackground("maps/advance_wars_day_of_ruin_campaign/cutscenes/bg_lin.png"); // 1 ScriptEventDialogItem
            var dialog12 = GameAnimationFactory.createGameAnimationDialog(qsTr("...Huh. I guess you're right."), "CO_LIN", GameEnums.COMood_Normal, "#ff0000"); dialog12.loadBackground("maps/advance_wars_day_of_ruin_campaign/cutscenes/bg_lin.png"); // 1 ScriptEventDialogItem
            var dialog13 = GameAnimationFactory.createGameAnimationDialog(qsTr("That was for you, Brenner. ...I think I'll see you soon."), "CO_LIN", GameEnums.COMood_Normal, "#ff0000"); dialog13.loadBackground("maps/advance_wars_day_of_ruin_campaign/cutscenes/bg_normal_general.png"); // 1 ScriptEventDialogItem
            var dialog14 = GameAnimationFactory.createGameAnimationDialog(qsTr("We did it! We won!"), "co_officier_ac", GameEnums.COMood_Normal, "#ff0000"); dialog14.loadBackground("maps/advance_wars_day_of_ruin_campaign/cutscenes/bg_camp_night_outside.png"); // 1 ScriptEventDialogItem
            var dialog15 = GameAnimationFactory.createGameAnimationDialog(qsTr("The war is over! You did it! Hurrah for Brenner's Wolves!"), "co_civilian7", GameEnums.COMood_Normal, "#ff0000"); dialog15.loadBackground("maps/advance_wars_day_of_ruin_campaign/cutscenes/bg_camp_night_outside.png"); // 1 ScriptEventDialogItem
            var dialog16 = GameAnimationFactory.createGameAnimationDialog(qsTr("Will! Everyone! Listen up! I just discovered huge stocks of the vaccine we need in Greyfield's headquarters! I think we can keep the infected alive long enough for me to find a cure. We did it! We did it! Oh ho ho ho!"), "co_dr_morris", GameEnums.COMood_Normal, "#ff0000"); dialog16.loadBackground("maps/advance_wars_day_of_ruin_campaign/cutscenes/bg_camp_night_outside.png"); // 1 ScriptEventDialogItem
            var dialog17 = GameAnimationFactory.createGameAnimationDialog(qsTr("Yeah, we... We did."), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog17.loadBackground("maps/advance_wars_day_of_ruin_campaign/cutscenes/bg_camp_night_outside.png"); // 1 ScriptEventDialogItem
            var dialog18 = GameAnimationFactory.createGameAnimationDialog(qsTr("Oh ho! This is no time for frowns. It's over! We won! It's time for the biggest celebration this world has ever seen!"), "co_dr_morris", GameEnums.COMood_Normal, "#ff0000"); dialog18.loadBackground("maps/advance_wars_day_of_ruin_campaign/cutscenes/bg_camp_night_outside.png"); // 1 ScriptEventDialogItem
            var dialog19 = GameAnimationFactory.createGameAnimationDialog(qsTr("Dr. Morris? I don't think Will..."), "CO_ISABELLA", GameEnums.COMood_Normal, "#ff0000"); dialog19.loadBackground("maps/advance_wars_day_of_ruin_campaign/cutscenes/bg_camp_night_outside.png"); // 1 ScriptEventDialogItem
            ...
            var dialog21 = GameAnimationFactory.createGameAnimationDialog(qsTr("We... We lost so many. So many people. A better commander could have prevented such losses. I'm just...not in the mood for a party. I'm sorry."), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog21.loadBackground("maps/advance_wars_day_of_ruin_campaign/cutscenes/bg_camp_night_outside.png"); // 1 ScriptEventDialogItem
            var dialog22 = GameAnimationFactory.createGameAnimationDialog(qsTr("Typical. If you were bigger and had better hair, I'd swear you were actually Brenner."), "CO_LIN", GameEnums.COMood_Normal, "#ff0000"); dialog22.loadBackground("maps/advance_wars_day_of_ruin_campaign/cutscenes/bg_camp_night_outside.png"); // 1 ScriptEventDialogItem
            var dialog23 = GameAnimationFactory.createGameAnimationDialog(qsTr("Lin, I..."), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog23.loadBackground("maps/advance_wars_day_of_ruin_campaign/cutscenes/bg_camp_night_outside.png"); // 1 ScriptEventDialogItem
            var dialog24 = GameAnimationFactory.createGameAnimationDialog(qsTr("We all love ya, Will, but please... Stop feeling sorry for yourself. You're the cadet who defeated an admiral. I think that's good enough."), "CO_LIN", GameEnums.COMood_Normal, "#ff0000"); dialog24.loadBackground("maps/advance_wars_day_of_ruin_campaign/cutscenes/bg_camp_night_outside.png"); // 1 ScriptEventDialogItem
            var dialog25 = GameAnimationFactory.createGameAnimationDialog(qsTr("But without you and Isabella and--"), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog25.loadBackground("maps/advance_wars_day_of_ruin_campaign/cutscenes/bg_camp_night_outside.png"); // 1 ScriptEventDialogItem
            var dialog26 = GameAnimationFactory.createGameAnimationDialog(qsTr("What you lacked in talent, you made up for with heart and guts. And you inspired every soldier to do the same, even those who never came home. That's what led us to victory. Not my tactics. Not Isabella's...whatever she does. It was you, and you should be proud. So let's go have a party."), "CO_LIN", GameEnums.COMood_Normal, "#ff0000"); dialog26.loadBackground("maps/advance_wars_day_of_ruin_campaign/cutscenes/bg_camp_night_outside.png"); // 1 ScriptEventDialogItem
            var dialog27 = GameAnimationFactory.createGameAnimationDialog(qsTr("...Yeah, all right."), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog27.loadBackground("maps/advance_wars_day_of_ruin_campaign/cutscenes/bg_camp_night_outside.png"); // 1 ScriptEventDialogItem
            var dialog28 = GameAnimationFactory.createGameAnimationDialog(qsTr("Oh ho ho ho! Now THAT'S the spirit! Let's party! I've got a few classic jokes that I save for special occasions..."), "CO_ANDY", GameEnums.COMood_Normal, "#ff0000"); dialog28.loadBackground("maps/advance_wars_day_of_ruin_campaign/cutscenes/bg_camp_night_outside.png"); // 1 ScriptEventDialogItem
    ...
    // preconditionend
        if (turn === 1 && player === 0) { // 0 Start Of Turn
            // Dialog
            var dialog0 = GameAnimationFactory.createGameAnimationDialog(qsTr("Ah. Admiral Greyfield. How can I help you?"), "CO_CAULDER", GameEnums.COMood_Normal, "#6038a0"); dialog0.loadBackground("maps/advance_wars_day_of_ruin_campaign/cutscenes/bg_glorious_tent_inside.png"); // 1 ScriptEventDialogItem
            var dialog1 = GameAnimationFactory.createGameAnimationDialog(qsTr("Caulder! What in the name of Rubinelle do you think you're doing?!"), "CO_GREYFIELD", GameEnums.COMood_Normal, "#d08000"); dialog1.loadBackground("maps/advance_wars_day_of_ruin_campaign/cutscenes/bg_glorious_tent_inside.png"); // 1 ScriptEventDialogItem
            var dialog2 = GameAnimationFactory.createGameAnimationDialog(qsTr("Whatever do you mean?"), "CO_CAULDER", GameEnums.COMood_Normal, "#6038a0"); dialog2.loadBackground("maps/advance_wars_day_of_ruin_campaign/cutscenes/bg_glorious_tent_inside.png"); // 1 ScriptEventDialogItem
            ...
            var dialog8 = GameAnimationFactory.createGameAnimationDialog(qsTr("Hmmm... Is everything all right, Admiral? You look somewhat unwell."), "CO_CAULDER", GameEnums.COMood_Normal, "#6038a0"); dialog8.loadBackground("maps/advance_wars_day_of_ruin_campaign/cutscenes/bg_glorious_tent_inside.png"); // 1 ScriptEventDialogItem
            var dialog9 = GameAnimationFactory.createGameAnimationDialog(qsTr("Wh-what do you mean?! How... How dare you mock the mighty Greyfield!"), "CO_GREYFIELD", GameEnums.COMood_Normal, "#d08000"); dialog9.loadBackground("maps/advance_wars_day_of_ruin_campaign/cutscenes/bg_glorious_tent_inside.png"); // 1 ScriptEventDialogItem
            var dialog10 = GameAnimationFactory.createGameAnimationDialog(qsTr("Ah ha! Not another word, Admiral! Your eyes tell me all I need to know. You too are infected with the virus! And that vaccine of yours can only hold it off for so long..."), "CO_CAULDER", GameEnums.COMood_Normal, "#6038a0"); dialog10.loadBackground("maps/advance_wars_day_of_ruin_campaign/cutscenes/bg_glorious_tent_inside.png"); // 1 ScriptEventDialogItem
            var dialog11 = GameAnimationFactory.createGameAnimationDialog(qsTr("B-bah. Bah! Admiral Greyfield will not be brought low by some common virus! Only the weak succumb to this disease, and I am not among their number! I am strong!"), "CO_GREYFIELD", GameEnums.COMood_Normal, "#d08000"); dialog11.loadBackground("maps/advance_wars_day_of_ruin_campaign/cutscenes/bg_glorious_tent_inside.png"); // 1 ScriptEventDialogItem
            var dialog12 = GameAnimationFactory.createGameAnimationDialog(qsTr("Your fear is palpable! If word spread that you had been infected, your army would crumble. You said yourself that this virus affects only the weak, did you not? I wonder, Admiral... Will you order your own firing squad to execute you as well?"), "CO_CAULDER", GameEnums.COMood_Normal, "#6038a0"); dialog12.loadBackground("maps/advance_wars_day_of_ruin_campaign/cutscenes/bg_glorious_tent_inside.png"); // 1 ScriptEventDialogItem
            var dialog13 = GameAnimationFactory.createGameAnimationDialog(qsTr("Insolence! I'll see you hanged for this!"), "CO_GREYFIELD", GameEnums.COMood_Normal, "#d08000"); dialog13.loadBackground("maps/advance_wars_day_of_ruin_campaign/cutscenes/bg_glorious_tent_inside.png"); // 1 ScriptEventDialogItem
            var dialog14 = GameAnimationFactory.createGameAnimationDialog(qsTr("Tsk tsk, Admiral. If you set me to swing, you will never find your cure. But worry not. Your little secret will be safe with me. And as we speak, I am but hours away from perfecting a cure."), "CO_CAULDER", GameEnums.COMood_Normal, "#6038a0"); dialog14.loadBackground("maps/advance_wars_day_of_ruin_campaign/cutscenes/bg_glorious_tent_inside.png"); // 1 ScriptEventDialogItem
            var dialog15 = GameAnimationFactory.createGameAnimationDialog(qsTr("...T-truly?"), "CO_GREYFIELD", GameEnums.COMood_Normal, "#d08000"); dialog15.loadBackground("maps/advance_wars_day_of_ruin_campaign/cutscenes/bg_glorious_tent_inside.png"); // 1 ScriptEventDialogItem
            var dialog16 = GameAnimationFactory.createGameAnimationDialog(qsTr("Truly."), "CO_CAULDER", GameEnums.COMood_Normal, "#6038a0"); dialog16.loadBackground("maps/advance_wars_day_of_ruin_campaign/cutscenes/bg_glorious_tent_inside.png"); // 1 ScriptEventDialogItem
