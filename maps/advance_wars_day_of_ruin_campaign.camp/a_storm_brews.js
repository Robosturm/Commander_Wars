var Constructor = function() { // scriptStart
    ...
    // preconditionend
        if (team === 0) { // 0 Victory
            ...
            var dialog8 = GameAnimationFactory.createGameAnimationDialog(qsTr("Oh, man! I thought we were goners!"), "co_davis", GameEnums.COMood_Normal, "#d08000"); dialog8.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_tent_inside.png"); // 1 ScriptEventDialogItem
            var dialog9 = GameAnimationFactory.createGameAnimationDialog(qsTr("Good to see you alive, Davis. What have you been up to?"), "CO_BRENNER", GameEnums.COMood_Normal, "#ff0000"); dialog9.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_tent_inside.png"); // 1 ScriptEventDialogItem
            var dialog10 = GameAnimationFactory.createGameAnimationDialog(qsTr("Me? Aw, I'm commanding a force for Admiral Greyfield. I've been looking all over for you, Captain Brenner! Look, I'll come straight out and say it...we want you and your men to join us."), "co_davis", GameEnums.COMood_Normal, "#d08000"); dialog10.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_tent_inside.png"); // 1 ScriptEventDialogItem
            var dialog11 = GameAnimationFactory.createGameAnimationDialog(qsTr("Explain."), "CO_BRENNER", GameEnums.COMood_Normal, "#ff0000"); dialog11.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_tent_inside.png"); // 1 ScriptEventDialogItem
            ...
            var dialog13 = GameAnimationFactory.createGameAnimationDialog(qsTr("This world is a slag heap. What could you possibly be fighting over?"), "CO_BRENNER", GameEnums.COMood_Normal, "#ff0000"); dialog13.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_tent_inside.png"); // 1 ScriptEventDialogItem
            ...
            var dialog15 = GameAnimationFactory.createGameAnimationDialog(qsTr("Continue. "), "CO_BRENNER", GameEnums.COMood_Normal, "#ff0000"); dialog15.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_tent_inside.png"); // 1 ScriptEventDialogItem
            ...
            var dialog17 = GameAnimationFactory.createGameAnimationDialog(qsTr("\"They\"? Who are you talking about?"), "CO_BRENNER", GameEnums.COMood_Normal, "#ff0000"); dialog17.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_tent_inside.png"); // 1 ScriptEventDialogItem
            ...
            var dialog19 = GameAnimationFactory.createGameAnimationDialog(qsTr("Our situation is none of Greyfield's concern."), "CO_BRENNER", GameEnums.COMood_Normal, "#ff0000"); dialog19.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_tent_inside.png"); // 1 ScriptEventDialogItem
    ...
    // preconditionend
        if (turn === 1 && player === 0) { // 0 Start Of Turn
            // Dialog
            var dialog0 = GameAnimationFactory.createGameAnimationDialog(qsTr("Any news, Will?"), "CO_BRENNER", GameEnums.COMood_Normal, "#ff0000"); dialog0.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_beach.png"); // 1 ScriptEventDialogItem
            var dialog1 = GameAnimationFactory.createGameAnimationDialog(qsTr("No, sir. Nobody's here either."), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog1.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_beach.png"); // 1 ScriptEventDialogItem
            var dialog2 = GameAnimationFactory.createGameAnimationDialog(qsTr("I see. We'll just have to keep looking."), "CO_BRENNER", GameEnums.COMood_Normal, "#ff0000"); dialog2.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_beach.png"); // 1 ScriptEventDialogItem
            ...
            var dialog12 = GameAnimationFactory.createGameAnimationDialog(qsTr("He doesn't make things easy for himself."), "CO_LIN", GameEnums.COMood_Normal, "#0098f8"); dialog12.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_beach.png"); // 1 ScriptEventDialogItem
            var dialog13 = GameAnimationFactory.createGameAnimationDialog(qsTr("No, he doesn't."), "CO_BRENNER", GameEnums.COMood_Normal, "#ff0000"); dialog13.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_beach.png"); // 1 ScriptEventDialogItem
            ...
            var dialog15 = GameAnimationFactory.createGameAnimationDialog(qsTr("War? The world is in ruins. There's no one left to start a war."), "CO_BRENNER", GameEnums.COMood_Normal, "#ff0000"); dialog15.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_beach.png"); // 1 ScriptEventDialogItem
            ...
            var dialog17 = GameAnimationFactory.createGameAnimationDialog(qsTr("Captain!"), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog17.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_beach.png"); // 1 ScriptEventDialogItem
            var dialog18 = GameAnimationFactory.createGameAnimationDialog(qsTr("What is it, Will?"), "CO_BRENNER", GameEnums.COMood_Normal, "#ff0000"); dialog18.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_beach.png"); // 1 ScriptEventDialogItem
            var dialog19 = GameAnimationFactory.createGameAnimationDialog(qsTr("Ships have been sighted off the coast! I can't be sure, but it looks like some Rubinelle Army survivors are under attack! Ships?"), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog19.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_beach.png"); // 1 ScriptEventDialogItem
