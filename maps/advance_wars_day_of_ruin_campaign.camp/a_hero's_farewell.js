var Constructor = function() { // scriptStart
    ...
    // preconditionend
        if (team === 0) { // 0 Victory
            ...
            var dialog5 = GameAnimationFactory.createGameAnimationDialog(qsTr("Stand down! That's an order, Flight Lieutenant. My final order..."), "CO_FORSYTHE", GameEnums.COMood_Normal, "#0098f8"); dialog5.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_dust_general.png"); // 1 ScriptEventDialogItem
            var dialog6 = GameAnimationFactory.createGameAnimationDialog(qsTr("General, we can't--"), "CO_TASHA", GameEnums.COMood_Normal, "#0098f8"); dialog6.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_dust_general.png"); // 1 ScriptEventDialogItem
            ...
            var dialog8 = GameAnimationFactory.createGameAnimationDialog(qsTr("It is an order, sir. And we will carry it out."), "CO_GAGE", GameEnums.COMood_Normal, "#0098f8"); dialog8.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_dust_general.png"); // 1 ScriptEventDialogItem
            ...
            var dialog10 = GameAnimationFactory.createGameAnimationDialog(qsTr("You are correct, sir. And I will surrender my forces to you on one condition."), "CO_FORSYTHE", GameEnums.COMood_Normal, "#0098f8"); dialog10.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_dust_general.png"); // 1 ScriptEventDialogItem
            var dialog11 = GameAnimationFactory.createGameAnimationDialog(qsTr("What is that?"), "CO_BRENNER", GameEnums.COMood_Normal, "#ff0000"); dialog11.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_dust_general.png"); // 1 ScriptEventDialogItem
            ...
            var dialog13 = GameAnimationFactory.createGameAnimationDialog(qsTr("...A fair request. I accept your terms."), "CO_BRENNER", GameEnums.COMood_Normal, "#ff0000"); dialog13.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_dust_general.png"); // 1 ScriptEventDialogItem
            ...
            var dialog17 = GameAnimationFactory.createGameAnimationDialog(qsTr("All right, Rube! I'm ready! Now you'll see how a Lazurian faces death!"), "CO_TASHA", GameEnums.COMood_Normal, "#0098f8"); dialog17.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_dust_general.png"); // 1 ScriptEventDialogItem
            var dialog18 = GameAnimationFactory.createGameAnimationDialog(qsTr("Um... I'm sorry, what?"), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog18.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_dust_general.png"); // 1 ScriptEventDialogItem
            ...
            var dialog22 = GameAnimationFactory.createGameAnimationDialog(qsTr("What? No! No, we would... Rubinelle would never attack civilian targets!"), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog22.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_dust_general.png"); // 1 ScriptEventDialogItem
            ...
            var dialog24 = GameAnimationFactory.createGameAnimationDialog(qsTr("That's...that's not...possible."), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog24.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_dust_general.png"); // 1 ScriptEventDialogItem
            ...
            var dialog26 = GameAnimationFactory.createGameAnimationDialog(qsTr("Captain Brenner? Admiral Greyfield has arrived."), "co_officier_ac", GameEnums.COMood_Normal, "#ff0000"); dialog26.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_dust_general.png"); // 1 ScriptEventDialogItem
            var dialog27 = GameAnimationFactory.createGameAnimationDialog(qsTr("...Too late to help us..."), "CO_BRENNER", GameEnums.COMood_Normal, "#ff0000"); dialog27.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_dust_general.png"); // 1 ScriptEventDialogItem
            ...
            var dialog29 = GameAnimationFactory.createGameAnimationDialog(qsTr("I am General Forsythe, commander of the Lazurian-- AAAAAAARRGGH!"), "CO_FORSYTHE", GameEnums.COMood_Normal, "#0098f8"); dialog29.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_dust_general.png"); // 1 ScriptEventDialogItem
            var dialog30 = GameAnimationFactory.createGameAnimationDialog(qsTr("You and your wretched army are a pathetic spectacle! A disgrace!"), "CO_GREYFIELD", GameEnums.COMood_Normal, "#d08000"); dialog30.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_dust_general.png"); // 1 ScriptEventDialogItem
            ...
            var dialog33 = GameAnimationFactory.createGameAnimationDialog(qsTr("...What?"), "CO_BRENNER", GameEnums.COMood_Normal, "#ff0000"); dialog33.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_dust_general.png"); // 1 ScriptEventDialogItem
            ...
            var dialog35 = GameAnimationFactory.createGameAnimationDialog(qsTr("Aaargh!"), "CO_FORSYTHE", GameEnums.COMood_Normal, "#0098f8"); dialog35.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_dust_general.png"); // 1 ScriptEventDialogItem
            var dialog36 = GameAnimationFactory.createGameAnimationDialog(qsTr("General Forsythe!"), "CO_BRENNER", GameEnums.COMood_Normal, "#ff0000"); dialog36.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_dust_general.png"); // 1 ScriptEventDialogItem
            var dialog37 = GameAnimationFactory.createGameAnimationDialog(qsTr("Captain Brenner.. R-remember... Your p-promise..."), "CO_FORSYTHE", GameEnums.COMood_Normal, "#0098f8"); dialog37.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_dust_general.png"); // 1 ScriptEventDialogItem
            var dialog38 = GameAnimationFactory.createGameAnimationDialog(qsTr("Damn you, Greyfield! He had surrendered! He was unarmed! Why did you shoot him?!"), "CO_BRENNER", GameEnums.COMood_Normal, "#ff0000"); dialog38.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_dust_general.png"); // 1 ScriptEventDialogItem
            var dialog39 = GameAnimationFactory.createGameAnimationDialog(qsTr("He was a Lazurian, and death is all he deserved."), "CO_GREYFIELD", GameEnums.COMood_Normal, "#d08000"); dialog39.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_dust_general.png"); // 1 ScriptEventDialogItem
            ...
            var dialog42 = GameAnimationFactory.createGameAnimationDialog(qsTr("You will pay for this, Greyfield..."), "CO_BRENNER", GameEnums.COMood_Normal, "#ff0000"); dialog42.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_dust_general.png"); // 1 ScriptEventDialogItem
