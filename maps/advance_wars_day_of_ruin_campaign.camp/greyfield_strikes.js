var Constructor = function() { // scriptStart
    ...
    // preconditionend
        if (team === 0) { // 0 Victory
            ...
            var dialog3 = GameAnimationFactory.createGameAnimationDialog(qsTr("...I see."), "CO_GREYFIELD", GameEnums.COMood_Normal, "#d08000"); dialog3.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_glorious_tent_inside.png"); // 1 ScriptEventDialogItem
            var dialog4 = GameAnimationFactory.createGameAnimationDialog(qsTr("A-Admiral? You're not...upset at our victory, are you?"), "co_officier_ti", GameEnums.COMood_Normal, "#ff0000"); dialog4.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_glorious_tent_inside.png"); // 1 ScriptEventDialogItem
            ...
            var dialog6 = GameAnimationFactory.createGameAnimationDialog(qsTr("Oh! Oh, golly, it's you!"), "co_civilian3", GameEnums.COMood_Normal, "#0098f8"); dialog6.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_normal_ruins.png"); // 1 ScriptEventDialogItem
            var dialog7 = GameAnimationFactory.createGameAnimationDialog(qsTr("I'm... I'm sorry. Do you know me?"), "CO_ISABELLA", GameEnums.COMood_Normal, "#ff0000"); dialog7.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_normal_ruins.png"); // 1 ScriptEventDialogItem
            ...
            var dialog9 = GameAnimationFactory.createGameAnimationDialog(qsTr("Oh... I'm...I'm sorry. I can't really remember anything."), "CO_ISABELLA", GameEnums.COMood_Normal, "#ff0000"); dialog9.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_normal_ruins.png"); // 1 ScriptEventDialogItem
            var dialog10 = GameAnimationFactory.createGameAnimationDialog(qsTr("Wait! You know Isabella? She's lost her memory. Anything you can tell us about her would be a big help."), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog10.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_normal_ruins.png"); // 1 ScriptEventDialogItem
            ...
            var dialog12 = GameAnimationFactory.createGameAnimationDialog(qsTr("She has a family?"), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog12.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_normal_ruins.png"); // 1 ScriptEventDialogItem
            ...
            var dialog14 = GameAnimationFactory.createGameAnimationDialog(qsTr("...I had a family?"), "CO_ISABELLA", GameEnums.COMood_Normal, "#ff0000"); dialog14.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_normal_ruins.png"); // 1 ScriptEventDialogItem
            var dialog15 = GameAnimationFactory.createGameAnimationDialog(qsTr("Do you know their names? Or where they are now?"), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog15.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_normal_ruins.png"); // 1 ScriptEventDialogItem
            ...
            var dialog17 = GameAnimationFactory.createGameAnimationDialog(qsTr("Why?"), "CO_ISABELLA", GameEnums.COMood_Normal, "#ff0000"); dialog17.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_normal_ruins.png"); // 1 ScriptEventDialogItem
            var dialog18 = GameAnimationFactory.createGameAnimationDialog(qsTr("Oh, I don't wanna be talkin' poorly about someone's family! Wouldn't be right."), "co_civilian3", GameEnums.COMood_Normal, "#0098f8"); dialog18.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_normal_ruins.png"); // 1 ScriptEventDialogItem
            var dialog19 = GameAnimationFactory.createGameAnimationDialog(qsTr("No! Please tell me! I want to know!"), "CO_ISABELLA", GameEnums.COMood_Normal, "#ff0000"); dialog19.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_normal_ruins.png"); // 1 ScriptEventDialogItem
            ...
            var dialog21 = GameAnimationFactory.createGameAnimationDialog(qsTr("That's...horrible."), "CO_ISABELLA", GameEnums.COMood_Normal, "#ff0000"); dialog21.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_normal_ruins.png"); // 1 ScriptEventDialogItem
            ...
            var dialog23 = GameAnimationFactory.createGameAnimationDialog(qsTr("..."), "CO_ISABELLA", GameEnums.COMood_Normal, "#ff0000"); dialog23.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_normal_ruins.png"); // 1 ScriptEventDialogItem
            var dialog24 = GameAnimationFactory.createGameAnimationDialog(qsTr("But they're just rumors, yah? Don'cha be payin' these things no mind."), "co_civilian3", GameEnums.COMood_Normal, "#0098f8"); dialog24.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_normal_ruins.png"); // 1 ScriptEventDialogItem
            var dialog25 = GameAnimationFactory.createGameAnimationDialog(qsTr("Will..."), "CO_ISABELLA", GameEnums.COMood_Normal, "#ff0000"); dialog25.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_normal_ruins.png"); // 1 ScriptEventDialogItem
            var dialog26 = GameAnimationFactory.createGameAnimationDialog(qsTr("Listen, Isabella, I'm sure that--"), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog26.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_normal_ruins.png"); // 1 ScriptEventDialogItem
            var dialog27 = GameAnimationFactory.createGameAnimationDialog(qsTr("Who am I? What am I? What if I did terrible things and don't remember it...?"), "CO_ISABELLA", GameEnums.COMood_Normal, "#ff0000"); dialog27.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_normal_ruins.png"); // 1 ScriptEventDialogItem
    ...
    // preconditionend
        if (turn === 1 && player === 0) { // 0 Start Of Turn
            // Dialog
            var dialog0 = GameAnimationFactory.createGameAnimationDialog(qsTr("WELL! Don't just stand there, fool! Give me your report!"), "CO_GREYFIELD", GameEnums.COMood_Normal, "#d08000"); dialog0.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_glorious_tent_inside.png"); // 1 ScriptEventDialogItem
            ...
            var dialog3 = GameAnimationFactory.createGameAnimationDialog(qsTr("On...on the coast, Admiral Greyfield. L-l-looking for the enemy..."), "co_davis", GameEnums.COMood_Normal, "#ff0000"); dialog3.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_glorious_tent_inside.png"); // 1 ScriptEventDialogItem
            ...
            var dialog5 = GameAnimationFactory.createGameAnimationDialog(qsTr("B-but, Admiral..."), "co_davis", GameEnums.COMood_Normal, "#ff0000"); dialog5.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_glorious_tent_inside.png"); // 1 ScriptEventDialogItem
            ...
            var dialog7 = GameAnimationFactory.createGameAnimationDialog(qsTr("Y-yes, sir! Absolutely right, Admiral. I'll... I'll get right on it."), "co_davis", GameEnums.COMood_Normal, "#ff0000"); dialog7.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_glorious_tent_inside.png"); // 1 ScriptEventDialogItem
