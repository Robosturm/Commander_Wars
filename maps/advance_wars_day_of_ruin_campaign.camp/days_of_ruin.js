var Constructor = function() { // scriptStart
    ...
    // preconditionend
        if (team === 0) { // 0 Victory
            // Dialog
            var dialog0 = GameAnimationFactory.createGameAnimationDialog(qsTr("You all right, kid?"), "CO_BRENNER", GameEnums.COMood_Normal, "#0098f8"); dialog0.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_dust_general.png"); // 1 ScriptEventDialogItem
            ...
            var dialog2 = GameAnimationFactory.createGameAnimationDialog(qsTr("A cadet huh? Thought I recognized that jacket. So what happened?"), "CO_BRENNER", GameEnums.COMood_Normal, "#0098f8"); dialog2.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_dust_general.png"); // 1 ScriptEventDialogItem
            ...
            var dialog4 = GameAnimationFactory.createGameAnimationDialog(qsTr("You did well to stay alive. I'm impressed."), "CO_BRENNER", GameEnums.COMood_Normal, "#0098f8"); dialog4.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_dust_general.png"); // 1 ScriptEventDialogItem
            var dialog5 = GameAnimationFactory.createGameAnimationDialog(qsTr(" I didn't want to die."), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog5.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_dust_general.png"); // 1 ScriptEventDialogItem
            ...
            var dialog7 = GameAnimationFactory.createGameAnimationDialog(qsTr("First Lieutenant Lin. Welcome to Brenner's Wolves."), "CO_LIN", GameEnums.COMood_Normal, "#0098f8"); dialog7.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_dust_general.png"); // 1 ScriptEventDialogItem
            ...
            var dialog9 = GameAnimationFactory.createGameAnimationDialog(qsTr("Yes, sir! That would be fantastic! You won't be sorry about..."), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog9.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_dust_general.png"); // 1 ScriptEventDialogItem
            var dialog10 = GameAnimationFactory.createGameAnimationDialog(qsTr("Are you all right?"), "CO_BRENNER", GameEnums.COMood_Normal, "#0098f8"); dialog10.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_dust_general.png"); // 1 ScriptEventDialogItem
            var dialog11 = GameAnimationFactory.createGameAnimationDialog(qsTr("Sorry, I haven't eaten in a long time."), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog11.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_dust_general.png"); // 1 ScriptEventDialogItem
    ...
    // preconditionend
        if (turn === 1 && player === 0) { // 0 Start Of Turn
            // Dialog
            var dialog0 = GameAnimationFactory.createGameAnimationDialog(qsTr("Our world is destroyed."), "CO_RANDOM", GameEnums.COMood_Normal, "#5c5663"); dialog0.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/intro_world.png"); // 1 ScriptEventDialogItem
