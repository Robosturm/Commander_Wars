var Constructor = function() { // scriptStart
    ...
    this.victory = function(team) { // victory
        ...
        if (team === 0) { // 0 Victory
            ...
            var dialog5 = GameAnimationFactory.createGameAnimationDialog(qsTr("Now if we can just find that factory..."), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog5.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_town.png"); // 1 ScriptEventDialogItem
            var dialog6 = GameAnimationFactory.createGameAnimationDialog(qsTr("What's the word, Doc? You and Lin give that system the once-over?"), "CO_BRENNER", GameEnums.COMood_Normal, "#ff0000"); dialog6.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_town.png"); // 1 ScriptEventDialogItem
            var dialog7 = GameAnimationFactory.createGameAnimationDialog(qsTr("Yes, well, hmm... I've got some good news, and I've got some bad news..."), "co_dr_morris", GameEnums.COMood_Normal, "#0098f8"); dialog7.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_town.png"); // 1 ScriptEventDialogItem
            var dialog8 = GameAnimationFactory.createGameAnimationDialog(qsTr("The system's useless. The factory has been destroyed."), "CO_LIN", GameEnums.COMood_Normal, "#0098f8"); dialog8.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_town.png"); // 1 ScriptEventDialogItem
            var dialog9 = GameAnimationFactory.createGameAnimationDialog(qsTr("What are you doing, Lin? I had a joke I wanted to tell first!"), "co_dr_morris", GameEnums.COMood_Normal, "#0098f8"); dialog9.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_town.png"); // 1 ScriptEventDialogItem
            ...
            var dialog12 = GameAnimationFactory.createGameAnimationDialog(qsTr("That's terrible, Dr. Morris. What are we supposed to do now?"), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog12.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_town.png"); // 1 ScriptEventDialogItem
            ...
            var dialog14 = GameAnimationFactory.createGameAnimationDialog(qsTr("There is? What?"), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog14.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_town.png"); // 1 ScriptEventDialogItem
            ...
            var dialog16 = GameAnimationFactory.createGameAnimationDialog(qsTr("It's as if they wanted us all to die."), "CO_LIN", GameEnums.COMood_Normal, "#0098f8"); dialog16.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_town.png"); // 1 ScriptEventDialogItem
            var dialog17 = GameAnimationFactory.createGameAnimationDialog(qsTr("Well, look at this..."), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog17.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_town.png"); // 1 ScriptEventDialogItem
            var dialog18 = GameAnimationFactory.createGameAnimationDialog(qsTr("Flowers. They're quite beautiful, aren't they? But there's something odd about them..."), "CO_LIN", GameEnums.COMood_Normal, "#0098f8"); dialog18.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_town.png"); // 1 ScriptEventDialogItem
            var dialog19 = GameAnimationFactory.createGameAnimationDialog(qsTr("Whatever you do, don't touch those flowers!"), "co_dr_morris", GameEnums.COMood_Normal, "#ff0000"); dialog19.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_town.png"); // 1 ScriptEventDialogItem
            var dialog20 = GameAnimationFactory.createGameAnimationDialog(qsTr("Dr. Morris?"), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog20.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_town.png"); // 1 ScriptEventDialogItem
            ...
            var dialog22 = GameAnimationFactory.createGameAnimationDialog(qsTr("...Maybe. I'm not as young as Isabella, but... Are you implying something, Doctor?"), "CO_LIN", GameEnums.COMood_Normal, "#0098f8"); dialog22.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_town.png"); // 1 ScriptEventDialogItem
            ...
            var dialog24 = GameAnimationFactory.createGameAnimationDialog(qsTr("Infect? What are you talking about?"), "CO_LIN", GameEnums.COMood_Normal, "#0098f8"); dialog24.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_town.png"); // 1 ScriptEventDialogItem
            ...
            var dialog26 = GameAnimationFactory.createGameAnimationDialog(qsTr("Oh. Look at that. How pretty."), "CO_LIN", GameEnums.COMood_Normal, "#0098f8"); dialog26.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_flowers2.png"); // 1 ScriptEventDialogItem
            var dialog27 = GameAnimationFactory.createGameAnimationDialog(qsTr("This young man was about your age, Will."), "co_dr_morris", GameEnums.COMood_Normal, "#0098f8"); dialog27.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_flowers2.png"); // 1 ScriptEventDialogItem
            var dialog28 = GameAnimationFactory.createGameAnimationDialog(qsTr("...He WAS my age?"), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog28.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_flowers2.png"); // 1 ScriptEventDialogItem
            ...
            var dialog30 = GameAnimationFactory.createGameAnimationDialog(qsTr("Wait, so the flowers...came out of his body?"), "CO_LIN", GameEnums.COMood_Normal, "#0098f8"); dialog30.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_flowers2.png"); // 1 ScriptEventDialogItem
            ...
            var dialog34 = GameAnimationFactory.createGameAnimationDialog(qsTr("Oh yeah. It's clear..."), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog34.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_flowers2.png"); // 1 ScriptEventDialogItem
            var dialog35 = GameAnimationFactory.createGameAnimationDialog(qsTr("Starvation, raiders, and flowers that kill you. Gotta love this place."), "CO_LIN", GameEnums.COMood_Normal, "#0098f8"); dialog35.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_flower_field.png"); // 1 ScriptEventDialogItem
            var dialog36 = GameAnimationFactory.createGameAnimationDialog(qsTr("The world's certainly not making it easy for us, is it? But we can't give up."), "CO_BRENNER", GameEnums.COMood_Normal, "#ff0000"); dialog36.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_flower_field.png"); // 1 ScriptEventDialogItem
            var dialog37 = GameAnimationFactory.createGameAnimationDialog(qsTr("As long as there's life, there's hope."), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog37.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_flower_field.png"); // 1 ScriptEventDialogItem
            var dialog38 = GameAnimationFactory.createGameAnimationDialog(qsTr("Exactly."), "CO_LIN", GameEnums.COMood_Normal, "#0098f8"); dialog38.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_flower_field.png"); // 1 ScriptEventDialogItem
    ...
    this.turnStart = function(turn, player) { // turnStart
        ...
        if (turn === 1 && player === 0) { // 0 Start Of Turn
            // Dialog
            var dialog0 = GameAnimationFactory.createGameAnimationDialog(qsTr("Tell me, my boy, do you know why it is dinosaurs became extinct?"), "co_dr_morris", GameEnums.COMood_Normal, "#0098f8"); dialog0.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_normal_general.png"); // 1 ScriptEventDialogItem
            var dialog1 = GameAnimationFactory.createGameAnimationDialog(qsTr("Huh? No, but I bet Captain Brenner does."), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog1.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_normal_general.png"); // 1 ScriptEventDialogItem
            var dialog2 = GameAnimationFactory.createGameAnimationDialog(qsTr("Not likely. Lin! Front and center."), "CO_BRENNER", GameEnums.COMood_Normal, "#0098f8"); dialog2.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_normal_general.png"); // 1 ScriptEventDialogItem
            var dialog3 = GameAnimationFactory.createGameAnimationDialog(qsTr("There are many possible explanations. I assume you're referring to the meteor theory?"), "CO_LIN", GameEnums.COMood_Normal, "#ff0000"); dialog3.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_normal_general.png"); // 1 ScriptEventDialogItem
            ...
            var dialog6 = GameAnimationFactory.createGameAnimationDialog(qsTr("But we survived our meteors."), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog6.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_normal_general.png"); // 1 ScriptEventDialogItem
            ...
            var dialog8 = GameAnimationFactory.createGameAnimationDialog(qsTr("Can we move this along, Doc? What is it you want to tell us?"), "CO_BRENNER", GameEnums.COMood_Normal, "#ff0000"); dialog8.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_normal_general.png"); // 1 ScriptEventDialogItem
            ...
            var dialog10 = GameAnimationFactory.createGameAnimationDialog(qsTr("So you're saying we're going to share their fate? Is that it?"), "CO_BRENNER", GameEnums.COMood_Normal, "#ff0000"); dialog10.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_normal_general.png"); // 1 ScriptEventDialogItem
            ...
            var dialog12 = GameAnimationFactory.createGameAnimationDialog(qsTr(""), "CO_BRENNER", GameEnums.COMood_Normal, "#ff0000"); dialog12.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_normal_general.png"); // 1 ScriptEventDialogItem
            ...
            var dialog16 = GameAnimationFactory.createGameAnimationDialog(qsTr("What's that, Dr. Morris?"), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog16.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_normal_general.png"); // 1 ScriptEventDialogItem
            ...
            var dialog18 = GameAnimationFactory.createGameAnimationDialog(qsTr("Uh...what are you talking about?"), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog18.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_normal_general.png"); // 1 ScriptEventDialogItem
            ...
            var dialog20 = GameAnimationFactory.createGameAnimationDialog(qsTr("Status report, Lin."), "CO_BRENNER", GameEnums.COMood_Normal, "#ff0000"); dialog20.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_normal_general.png"); // 1 ScriptEventDialogItem
