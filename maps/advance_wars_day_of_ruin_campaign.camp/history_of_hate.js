var Constructor = function() { // scriptStart
    ...
    // preconditionend
        if (team === 0) { // 0 Victory
            ...
            var dialog1 = GameAnimationFactory.createGameAnimationDialog(qsTr("Will, Lin. Look to the wounded."), "CO_BRENNER", GameEnums.COMood_Normal, "#ff0000"); dialog1.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_normal_general.png"); // 1 ScriptEventDialogItem
            var dialog2 = GameAnimationFactory.createGameAnimationDialog(qsTr("OK. We'll split up and begin searching for survivors..."), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog2.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_normal_general.png"); // 1 ScriptEventDialogItem
            ...
            var dialog4 = GameAnimationFactory.createGameAnimationDialog(qsTr("Captain Waylon?"), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog4.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_normal_general.png"); // 1 ScriptEventDialogItem
            ...
            var dialog6 = GameAnimationFactory.createGameAnimationDialog(qsTr("Captain Brenner is a great man!"), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog6.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_normal_general.png"); // 1 ScriptEventDialogItem
            var dialog7 = GameAnimationFactory.createGameAnimationDialog(qsTr("What?! "), "CO_WAYLON", GameEnums.COMood_Normal, "#d08000"); dialog7.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_normal_general.png"); // 1 ScriptEventDialogItem
            ...
            var dialog10 = GameAnimationFactory.createGameAnimationDialog(qsTr("He wants to see me?"), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog10.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_normal_general.png"); // 1 ScriptEventDialogItem
            ...
            var dialog12 = GameAnimationFactory.createGameAnimationDialog(qsTr("You wanted to see me, Admiral?"), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog12.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_glorious_tent_inside.png"); // 1 ScriptEventDialogItem
            ...
            var dialog14 = GameAnimationFactory.createGameAnimationDialog(qsTr("Umm... Thank you?"), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog14.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_glorious_tent_inside.png"); // 1 ScriptEventDialogItem
            ...
            var dialog16 = GameAnimationFactory.createGameAnimationDialog(qsTr("I... I think it's terrible--"), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog16.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_glorious_tent_inside.png"); // 1 ScriptEventDialogItem
            var dialog17 = GameAnimationFactory.createGameAnimationDialog(qsTr("WRONG! You have made a fundamental error! Do not do so again!"), "CO_GREYFIELD", GameEnums.COMood_Normal, "#d08000"); dialog17.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_glorious_tent_inside.png"); // 1 ScriptEventDialogItem
            var dialog18 = GameAnimationFactory.createGameAnimationDialog(qsTr("An error?"), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog18.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_glorious_tent_inside.png"); // 1 ScriptEventDialogItem
            ...
            var dialog20 = GameAnimationFactory.createGameAnimationDialog(qsTr("A...test?"), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog20.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_glorious_tent_inside.png"); // 1 ScriptEventDialogItem
            ...
            var dialog22 = GameAnimationFactory.createGameAnimationDialog(qsTr("But people died! They lost their lives!"), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog22.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_glorious_tent_inside.png"); // 1 ScriptEventDialogItem
            var dialog23 = GameAnimationFactory.createGameAnimationDialog(qsTr("It is natural that the weak should perish! "), "CO_GREYFIELD", GameEnums.COMood_Normal, "#d08000"); dialog23.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_glorious_tent_inside.png"); // 1 ScriptEventDialogItem
            var dialog24 = GameAnimationFactory.createGameAnimationDialog(qsTr("I... I don't..."), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog24.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_glorious_tent_inside.png"); // 1 ScriptEventDialogItem
            ...
            var dialog26 = GameAnimationFactory.createGameAnimationDialog(qsTr("...You're wrong!"), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog26.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_glorious_tent_inside.png"); // 1 ScriptEventDialogItem
            var dialog27 = GameAnimationFactory.createGameAnimationDialog(qsTr("What did you say?"), "CO_GREYFIELD", GameEnums.COMood_Normal, "#d08000"); dialog27.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_glorious_tent_inside.png"); // 1 ScriptEventDialogItem
            var dialog28 = GameAnimationFactory.createGameAnimationDialog(qsTr("My parents were killed in the war! My friends were killed by the meteors. You think it is natural that they died? You think they failed some crazy test? You're wrong! And I'm not afraid to say it!"), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog28.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_glorious_tent_inside.png"); // 1 ScriptEventDialogItem
            ...
            var dialog30 = GameAnimationFactory.createGameAnimationDialog(qsTr("..."), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog30.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_glorious_tent_inside.png"); // 1 ScriptEventDialogItem
    ...
    // preconditionend
        if (turn === 1 && player === 0) { // 0 Start Of Turn
            // Dialog
            var dialog0 = GameAnimationFactory.createGameAnimationDialog(qsTr("Admiral Greyfield, the 12th Battalion commander has arrived."), "co_davis", GameEnums.COMood_Normal, "#d08000"); dialog0.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_glorious_tent_inside.png"); // 1 ScriptEventDialogItem
            var dialog1 = GameAnimationFactory.createGameAnimationDialog(qsTr("...WELL?! Don't just stand there like a slack-jawed idiot! Send him in!"), "CO_GREYFIELD", GameEnums.COMood_Normal, "#d08000"); dialog1.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_glorious_tent_inside.png"); // 1 ScriptEventDialogItem
            var dialog2 = GameAnimationFactory.createGameAnimationDialog(qsTr("...Admiral."), "CO_BRENNER", GameEnums.COMood_Normal, "#ff0000"); dialog2.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_glorious_tent_inside.png"); // 1 ScriptEventDialogItem
            ...
            var dialog4 = GameAnimationFactory.createGameAnimationDialog(qsTr("For now."), "CO_BRENNER", GameEnums.COMood_Normal, "#ff0000"); dialog4.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_glorious_tent_inside.png"); // 1 ScriptEventDialogItem
            ...
            var dialog10 = GameAnimationFactory.createGameAnimationDialog(qsTr("Oh, good. Waylon's here."), "CO_BRENNER", GameEnums.COMood_Normal, "#ff0000"); dialog10.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_glorious_tent_inside.png"); // 1 ScriptEventDialogItem
            ...
            var dialog13 = GameAnimationFactory.createGameAnimationDialog(qsTr(""), "CO_WAYLON", GameEnums.COMood_Normal, "#d08000"); dialog13.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_glorious_tent_inside.png"); // 1 ScriptEventDialogItem
            var dialog14 = GameAnimationFactory.createGameAnimationDialog(qsTr("Typical."), "CO_BRENNER", GameEnums.COMood_Normal, "#ff0000"); dialog14.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_glorious_tent_inside.png"); // 1 ScriptEventDialogItem
            var dialog15 = GameAnimationFactory.createGameAnimationDialog(qsTr("L-look...Admiral Greyfield has taken over the former military and built the New Rubinelle Army. But we need help to beat those crafty Lazurians. ...N-not that you need any help, Admiral! Um... Oh Great One..."), "co_davis", GameEnums.COMood_Normal, "#d08000"); dialog15.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_glorious_tent_inside.png"); // 1 ScriptEventDialogItem
            ...
            var dialog19 = GameAnimationFactory.createGameAnimationDialog(qsTr("Yes! I don't believe it!"), "co_davis", GameEnums.COMood_Normal, "#d08000"); dialog19.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_glorious_tent_inside.png"); // 1 ScriptEventDialogItem
            ...
            var dialog21 = GameAnimationFactory.createGameAnimationDialog(qsTr("...I hope this is over soon."), "CO_BRENNER", GameEnums.COMood_Normal, "#ff0000"); dialog21.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_glorious_tent_inside.png"); // 1 ScriptEventDialogItem
            ...
            var dialog23 = GameAnimationFactory.createGameAnimationDialog(qsTr("Y-yes, sir! B-but I always remember him as a good fighter..."), "co_davis", GameEnums.COMood_Normal, "#d08000"); dialog23.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_glorious_tent_inside.png"); // 1 ScriptEventDialogItem
