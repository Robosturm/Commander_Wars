var Constructor = function() { // scriptStart
    ...
    // preconditionend
        if (team === 0) { // 0 Victory
            ...
            var dialog6 = GameAnimationFactory.createGameAnimationDialog(qsTr("...What the heck happened? I thought we were done for."), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog6.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_camp_night_outside.png"); // 1 ScriptEventDialogItem
            ...
            var dialog9 = GameAnimationFactory.createGameAnimationDialog(qsTr("Save the commentary. Why did you pull back?"), "CO_GAGE", GameEnums.COMood_Normal, "#ff0000"); dialog9.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_camp_night_outside.png"); // 1 ScriptEventDialogItem
            var dialog10 = GameAnimationFactory.createGameAnimationDialog(qsTr("Not sure. I heard rumors that the rear guard had rebelled against the admiral. My guess? They sent frontline units back to put down the uprising. Last I heard, things were getting out of hand pretty fast."), "co_officier_ti", GameEnums.COMood_Normal, "#ff0000"); dialog10.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_camp_night_outside.png"); // 1 ScriptEventDialogItem
            ...
            var dialog12 = GameAnimationFactory.createGameAnimationDialog(qsTr("Ha! What, you ain't heard about the disease?"), "co_officier_ti", GameEnums.COMood_Normal, "#ff0000"); dialog12.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_camp_night_outside.png"); // 1 ScriptEventDialogItem
            var dialog13 = GameAnimationFactory.createGameAnimationDialog(qsTr("Are you referring to Endoflorescens terribilis?"), "CO_LIN", GameEnums.COMood_Normal, "#ff0000"); dialog13.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_camp_night_outside.png"); // 1 ScriptEventDialogItem
            var dialog14 = GameAnimationFactory.createGameAnimationDialog(qsTr("We call it the Creeper."), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog14.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_camp_night_outside.png"); // 1 ScriptEventDialogItem
            ...
            var dialog17 = GameAnimationFactory.createGameAnimationDialog(qsTr("The same virus that almost caused rebellion in our ranks ended up saving us. ...Huh. You know what? Life's a funny thing."), "CO_LIN", GameEnums.COMood_Normal, "#ff0000"); dialog17.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_camp_night_outside.png"); // 1 ScriptEventDialogItem
            ...
            var dialog19 = GameAnimationFactory.createGameAnimationDialog(qsTr("...Thank you, Doctor."), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog19.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_tent_inside.png"); // 1 ScriptEventDialogItem
            ...
            var dialog22 = GameAnimationFactory.createGameAnimationDialog(qsTr("Let's see... Nope! You're as healthy as a horse. Maybe I should get you some hay! Oh ho ho ho!"), "co_dr_morris", GameEnums.COMood_Normal, "#ff0000"); dialog22.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_tent_inside.png"); // 1 ScriptEventDialogItem
            var dialog23 = GameAnimationFactory.createGameAnimationDialog(qsTr("Er...yes. Thanks."), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog23.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_tent_inside.png"); // 1 ScriptEventDialogItem
            ...
            var dialog26 = GameAnimationFactory.createGameAnimationDialog(qsTr("Blast! I thought you were going to say that! Under normal circumstances, a doctor would never allow a patient to take such risks."), "co_dr_morris", GameEnums.COMood_Normal, "#ff0000"); dialog26.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_tent_inside.png"); // 1 ScriptEventDialogItem
            ...
            var dialog28 = GameAnimationFactory.createGameAnimationDialog(qsTr("Are you scared?"), "CO_LIN", GameEnums.COMood_Normal, "#ff0000"); dialog28.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_tent_inside.png"); // 1 ScriptEventDialogItem
            var dialog29 = GameAnimationFactory.createGameAnimationDialog(qsTr("Lin?"), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog29.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_tent_inside.png"); // 1 ScriptEventDialogItem
            ...
            var dialog32 = GameAnimationFactory.createGameAnimationDialog(qsTr("Will, I... I talked to Dr. Morris. I have the virus."), "CO_LIN", GameEnums.COMood_Normal, "#ff0000"); dialog32.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_tent_inside.png"); // 1 ScriptEventDialogItem
            var dialog33 = GameAnimationFactory.createGameAnimationDialog(qsTr("Oh, Lin! No!"), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog33.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_tent_inside.png"); // 1 ScriptEventDialogItem
            var dialog34 = GameAnimationFactory.createGameAnimationDialog(qsTr("Are you sure you don't want to leave? No one would think less of you."), "CO_LIN", GameEnums.COMood_Normal, "#ff0000"); dialog34.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_tent_inside.png"); // 1 ScriptEventDialogItem
            var dialog35 = GameAnimationFactory.createGameAnimationDialog(qsTr("No. I won't run away. We will find a cure. I have hope."), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog35.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_tent_inside.png"); // 1 ScriptEventDialogItem
    ...
    // preconditionend
        if (turn === 1 && player === 0) { // 0 Start Of Turn
            ...
            var dialog2 = GameAnimationFactory.createGameAnimationDialog(qsTr("He won't stop until he's destroyed every last Lazurian. I think he's kinda crazy."), "CO_TASHA", GameEnums.COMood_Normal, "#f00008"); dialog2.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_tent_inside.png"); // 1 ScriptEventDialogItem
            ...
            var dialog4 = GameAnimationFactory.createGameAnimationDialog(qsTr("What can we do? We make a stand here and hope for the best."), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog4.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_tent_inside.png"); // 1 ScriptEventDialogItem
            ...
            var dialog6 = GameAnimationFactory.createGameAnimationDialog(qsTr("I know, Lin. But we don't have a choice."), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog6.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_tent_inside.png"); // 1 ScriptEventDialogItem
            var dialog7 = GameAnimationFactory.createGameAnimationDialog(qsTr("No. There is a choice."), "CO_TASHA", GameEnums.COMood_Normal, "#ff0000"); dialog7.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_tent_inside.png"); // 1 ScriptEventDialogItem
            var dialog8 = GameAnimationFactory.createGameAnimationDialog(qsTr("What is it, Tasha?"), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog8.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_tent_inside.png"); // 1 ScriptEventDialogItem
            var dialog9 = GameAnimationFactory.createGameAnimationDialog(qsTr("Hand us over to Greyfield."), "CO_TASHA", GameEnums.COMood_Normal, "#ff0000"); dialog9.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_tent_inside.png"); // 1 ScriptEventDialogItem
            var dialog10 = GameAnimationFactory.createGameAnimationDialog(qsTr("Out of the question! You're our allies. Our friends. We would never do that!"), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog10.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_tent_inside.png"); // 1 ScriptEventDialogItem
            ...
            var dialog12 = GameAnimationFactory.createGameAnimationDialog(qsTr("What about it, Lieutenant? I bet you thought of this a while ago, huh?"), "CO_TASHA", GameEnums.COMood_Normal, "#ff0000"); dialog12.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_tent_inside.png"); // 1 ScriptEventDialogItem
            var dialog13 = GameAnimationFactory.createGameAnimationDialog(qsTr("I considered it."), "CO_LIN", GameEnums.COMood_Normal, "#ff0000"); dialog13.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_tent_inside.png"); // 1 ScriptEventDialogItem
            var dialog14 = GameAnimationFactory.createGameAnimationDialog(qsTr("Lin!"), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog14.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_tent_inside.png"); // 1 ScriptEventDialogItem
            ...
            var dialog16 = GameAnimationFactory.createGameAnimationDialog(qsTr("I'm ready."), "CO_GAGE", GameEnums.COMood_Normal, "#ff0000"); dialog16.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_tent_inside.png"); // 1 ScriptEventDialogItem
            var dialog17 = GameAnimationFactory.createGameAnimationDialog(qsTr("Tasha! Gage! No! This is madness!"), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog17.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_tent_inside.png"); // 1 ScriptEventDialogItem
            var dialog18 = GameAnimationFactory.createGameAnimationDialog(qsTr("Will, listen--"), "CO_TASHA", GameEnums.COMood_Normal, "#ff0000"); dialog18.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_tent_inside.png"); // 1 ScriptEventDialogItem
            ...
            var dialog20 = GameAnimationFactory.createGameAnimationDialog(qsTr("Are you sure?"), "CO_GAGE", GameEnums.COMood_Normal, "#ff0000"); dialog20.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_tent_inside.png"); // 1 ScriptEventDialogItem
            var dialog21 = GameAnimationFactory.createGameAnimationDialog(qsTr("I'm sure. But that's not going to happen. Greyfield isn't going to beat us."), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog21.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_tent_inside.png"); // 1 ScriptEventDialogItem
            var dialog22 = GameAnimationFactory.createGameAnimationDialog(qsTr("If that is your decision Commander... Then we will follow you."), "CO_LIN", GameEnums.COMood_Normal, "#ff0000"); dialog22.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_tent_inside.png"); // 1 ScriptEventDialogItem
            var dialog23 = GameAnimationFactory.createGameAnimationDialog(qsTr("Oh ho! Sorry to interrupt, but I have to speak to you right now!"), "co_dr_morris", GameEnums.COMood_Normal, "#ff0000"); dialog23.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_tent_inside.png"); // 1 ScriptEventDialogItem
            var dialog24 = GameAnimationFactory.createGameAnimationDialog(qsTr("This can't be good."), "CO_LIN", GameEnums.COMood_Normal, "#ff0000"); dialog24.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_tent_inside.png"); // 1 ScriptEventDialogItem
            var dialog25 = GameAnimationFactory.createGameAnimationDialog(qsTr("I've finished screening people for the Creeper, and the results are disheartening..."), "co_dr_morris", GameEnums.COMood_Normal, "#ff0000"); dialog25.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_tent_inside.png"); // 1 ScriptEventDialogItem
            var dialog26 = GameAnimationFactory.createGameAnimationDialog(qsTr("...Half of us are already infected?"), "CO_LIN", GameEnums.COMood_Normal, "#ff0000"); dialog26.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_tent_inside.png"); // 1 ScriptEventDialogItem
            var dialog27 = GameAnimationFactory.createGameAnimationDialog(qsTr("I'm afraid so. The virus has spread to civilian, Rubinelle, and Lazurian alike. I think the infection started before we even entered the trading outpost. ...I can't even think of a joke for this. And I've been trying for a while."), "co_dr_morris", GameEnums.COMood_Normal, "#ff0000"); dialog27.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_tent_inside.png"); // 1 ScriptEventDialogItem
            var dialog28 = GameAnimationFactory.createGameAnimationDialog(qsTr("But everyone seems fine!"), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog28.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_tent_inside.png"); // 1 ScriptEventDialogItem
            ...
            var dialog30 = GameAnimationFactory.createGameAnimationDialog(qsTr("This is not what we needed..."), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog30.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_tent_inside.png"); // 1 ScriptEventDialogItem
