var Constructor = function() { // scriptStart
    ...
    // preconditionend
        if (team === 0) { // 0 Victory
            ...
            var dialog2 = GameAnimationFactory.createGameAnimationDialog(qsTr("We're awaiting confirmation on the enemy withdrawal."), "CO_LIN", GameEnums.COMood_Normal, "#0098f8"); dialog2.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_dust_general.png"); // 1 ScriptEventDialogItem
            var dialog3 = GameAnimationFactory.createGameAnimationDialog(qsTr("Sir, they're gone! There's not a raider to be seen for miles!"), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog3.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_dust_general.png"); // 1 ScriptEventDialogItem
            var dialog4 = GameAnimationFactory.createGameAnimationDialog(qsTr("Good work, everyone."), "CO_BRENNER", GameEnums.COMood_Normal, "#0098f8"); dialog4.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_dust_general.png"); // 1 ScriptEventDialogItem
            ...
            var dialog6 = GameAnimationFactory.createGameAnimationDialog(qsTr("Is that so?"), "CO_BRENNER", GameEnums.COMood_Normal, "#ff0000"); dialog6.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_ruins_dust_general.png"); // 1 ScriptEventDialogItem
            var dialog7 = GameAnimationFactory.createGameAnimationDialog(qsTr("It is. However, there is one...condition."), "co_major", GameEnums.COMood_Normal, "#0098f8"); dialog7.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_ruins_dust_general.png"); // 1 ScriptEventDialogItem
            var dialog8 = GameAnimationFactory.createGameAnimationDialog(qsTr("Go on."), "CO_BRENNER", GameEnums.COMood_Normal, "#0098f8"); dialog8.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_ruins_dust_general.png"); // 1 ScriptEventDialogItem
            ...
            var dialog10 = GameAnimationFactory.createGameAnimationDialog(qsTr("Kids? Hey, I can look after--"), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog10.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_ruins_dust_general.png"); // 1 ScriptEventDialogItem
            ...
            var dialog12 = GameAnimationFactory.createGameAnimationDialog(qsTr("I get it. So we wipe out the raiders, and you'll agree to take in--"), "CO_BRENNER", GameEnums.COMood_Normal, "#0098f8"); dialog12.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_ruins_dust_general.png"); // 1 ScriptEventDialogItem
    ...
    // preconditionend
        if (turn === 1 && player === 0) { // 0 Start Of Turn
            // Dialog
            var dialog0 = GameAnimationFactory.createGameAnimationDialog(qsTr("OK. See this spot on the map? That's our next destination. It's a small village."), "CO_BRENNER", GameEnums.COMood_Normal, "#0098f8"); dialog0.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_tent_inside.png"); // 1 ScriptEventDialogItem
            var dialog1 = GameAnimationFactory.createGameAnimationDialog(qsTr("A village? With people?"), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog1.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_tent_inside.png"); // 1 ScriptEventDialogItem
            ...
            var dialog3 = GameAnimationFactory.createGameAnimationDialog(qsTr("Laws? Why do they have laws? The world's been destroyed. There's no one left to help them enforce their laws."), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog3.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_tent_inside.png"); // 1 ScriptEventDialogItem
            ...
            var dialog9 = GameAnimationFactory.createGameAnimationDialog(qsTr("What if you're with those raiders? What if you're here to attack us?"), "co_civilian1", GameEnums.COMood_Normal, "#ff0000"); dialog9.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_dust_general.png"); // 1 ScriptEventDialogItem
            var dialog10 = GameAnimationFactory.createGameAnimationDialog(qsTr("Yeah, I bet that's it! You came back to kill us all, didn't you?"), "co_civilian5", GameEnums.COMood_Normal, "#0098f8"); dialog10.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_dust_general.png"); // 1 ScriptEventDialogItem
            ...
            var dialog12 = GameAnimationFactory.createGameAnimationDialog(qsTr("C'mon guys! Help us out, will you?"), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog12.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_dust_general.png"); // 1 ScriptEventDialogItem
            ...
            var dialog14 = GameAnimationFactory.createGameAnimationDialog(qsTr("About time..."), "CO_BRENNER", GameEnums.COMood_Normal, "#0098f8"); dialog14.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_dust_general.png"); // 1 ScriptEventDialogItem
            ...
            var dialog22 = GameAnimationFactory.createGameAnimationDialog(qsTr("So you think they're not worth saving?"), "CO_BRENNER", GameEnums.COMood_Normal, "#0098f8"); dialog22.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_ruins_dust_general.png"); // 1 ScriptEventDialogItem
            ...
            var dialog24 = GameAnimationFactory.createGameAnimationDialog(qsTr("I see."), "CO_BRENNER", GameEnums.COMood_Normal, "#0098f8"); dialog24.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_ruins_dust_general.png"); // 1 ScriptEventDialogItem
            ...
            var dialog28 = GameAnimationFactory.createGameAnimationDialog(qsTr("Don't worry, Captain, that's fine with--"), "CO_WILL", GameEnums.COMood_Normal, "#ff0000"); dialog28.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_ruins_dust_general.png"); // 1 ScriptEventDialogItem
            var dialog29 = GameAnimationFactory.createGameAnimationDialog(qsTr("Head for cover! Those raiders are back! Where's the mayor?!"), "co_civilian5", GameEnums.COMood_Normal, "#0098f8"); dialog29.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_ruins_dust_general.png"); // 1 ScriptEventDialogItem
            var dialog30 = GameAnimationFactory.createGameAnimationDialog(qsTr("The raiders? Are you sure?"), "co_major", GameEnums.COMood_Normal, "#0098f8"); dialog30.loadBackground("maps/advance_wars_day_of_ruin_campaign.camp/cutscenes/bg_ruins_dust_general.png"); // 1 ScriptEventDialogItem
