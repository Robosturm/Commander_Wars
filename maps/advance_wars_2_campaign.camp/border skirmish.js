var Constructor = function()
{
    ...
    this.actionDone = function(action, map)
    {
        ...
        if (mech === null || mech.getHasMoved() === true)
        {
            ...
            {
                var dialog = GameAnimationFactory.createGameAnimationDialog(map, 
        ...
        if (inf === null || inf.getHasMoved() === true)
        {
            ...
            {
                gameScript.captureDialog(map);
                captureDialog.writeDataBool(true);
            }
        }
    };

    this.artDialog = function(map)
    {
        var dialog1 = GameAnimationFactory.createGameAnimationDialog(map, 
    ...
    this.captureDialog = function(map)
    {
        var dialog1 = GameAnimationFactory.createGameAnimationDialog(map, 
