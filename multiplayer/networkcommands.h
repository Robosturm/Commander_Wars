...
namespace NetworkCommands
{
    ...
    // 2 factor authentication (totp) commands
    const char* const SETUP2FA = "SETUP2FA";
    const char* const SERVERRESPONSSETUP2FA = "SERVERRESPONSSETUP2FA";
    const char* const CONFIRM2FA = "CONFIRM2FA";
    const char* const SERVERRESPONSCONFIRM2FA = "SERVERRESPONSCONFIRM2FA";
    const char* const CANCEL2FA = "CANCEL2FA";
    const char* const SUBMITPASSWORDRESET2FACODE = "SUBMITPASSWORDRESET2FACODE";
    const char* const SERVERRESPONSRESETPASSWORD2FA = "SERVERRESPONSRESETPASSWORD2FA";
    ...
    const char* const GATEWAYCLIENTDISCONNECTED = "GATEWAYCLIENTDISCONNECTED";
    const char* const GATEWAYCLIENTCONNECTED = "GATEWAYCLIENTCONNECTED";
}
