...
using spScriptConditionPlayerDefeated = oxygine::intrusive_ptr<ScriptConditionPlayerDefeated>;

class ScriptConditionPlayerDefeated final : public ScriptCondition
{
    Q_OBJECT
public:
